...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // This is to adjust the padding to accommodate the status and navigation bar.
        ...
        // This retrieves the stored username from shared preferences.
        val sharedPref = getSharedPreferences("UserPrefs", Context.MODE_PRIVATE)
        val username = sharedPref.getString("username", "User")

        // This displays the the username on the profile screen.
        val textViewUsername = findViewById<TextView>(R.id.textViewUsername)
        textViewUsername.text = username

        // This is the logout button that clears session and goes back to login screen.
        ...
        // This is the button to navigate to the Change Password screen.
